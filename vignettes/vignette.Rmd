...
```{r}
scores = testUnidirectionality(barycoords, gsets, Gdiffexp, statistic = "diffexp", mc.cores = 1)
...
cowplot::plot_grid(
  plotDotplot(barycoords, Gdiffexp, Goi=gsets[[gsetid]]) + ggplot2::theme(legend.position = "none"), 
