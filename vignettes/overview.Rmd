...
![](img/interactive.png "Example of a triwise plot with annotated genes")

The three biological conditions can be related in different ways:

![](img/setups.png "Possible experimental set-ups")
...
# Funding
[![](img/fwo_small.png)](http://www.fwo.be)
[![](img/logo_UGent_EN_RGB_2400_color-on-white_small.png)](http://www.ugent.be)
[![](img/VIB-IRC-logo-compact_small.jpg)](http://irc.ugent.be)
