...
interactiveDotplot(Eoi, Gdiffexp, Glabels = featureData(vandelaar)$symbol)
```
...
```{r}
scores = testUnidirectionality(barycoords, gsets, Gdiffexp, statistic = "r", mc.cores = 8)
...
row = scores[3,]
row = scores[scores$name == "positive regulation of smooth muscle cell proliferation", ]
print(row$name)
